...
using GenIBANProject;
using HtmlAgilityPack; // => Find Key from HTML Code
using PuppeteerSharp; // => Simulate Chrome from Computer to  Get HTML and  Send Click Event
...
namespace ConsoleApp11
{
    class Program
    {
        private static string GetResult_IBAN(string result_IBAN)
        {
            return result_IBAN;
        }
        ...
        {
            #region Find Path Google Chrome To simulate  Get HTML by Browser (Real Simulate)
        ...
        public static string GetIBANNo(string result)
        {
